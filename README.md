...
The following results, generated by the `benchstat` tool, compare the performance of the `HybribToLower` function before and after the optimization. 
...
| HybribToLowerLowerCase-24  | 747.4n ± 0%      | 750.1n ± 1%      | ~ (p=0.289 n=10) |
| HybribToLowerMixedCase-24  | 1.281µ ± 0%      | 1.146µ ± 0%      | -10.54% (p=0.000 n=10) |
...
| HybribToLowerLowerCase-24  | 0.000 ± 0%     | 0.000 ± 0%     | ~ (p=1.000 n=10) ¹ |
| HybribToLowerMixedCase-24  | 808.0 ± 0%     | 808.0 ± 0%     | ~ (p=1.000 n=10) ¹ |
| geomean                    |                |                | +0.00%          |
...
| HybribToLowerLowerCase-24  | 0.000 ± 0%          | 0.000 ± 0%          | ~ (p=1.000 n=10) ¹  |
| HybribToLowerMixedCase-24  | 5.000 ± 0%          | 5.000 ± 0%          | ~ (p=1.000 n=10) ¹  |
| geomean                    |                     |                     | +0.00%              |